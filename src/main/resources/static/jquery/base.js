...
function toast(msg,duration){
    ...
    m.innerHTML = "<img src='/static/home/waiting.gif' style='text-align: left;margin: 5px;width: 20px;height: 20px '> <br>  <span style='margin-left: 20px;height: 20px;'>"+msg+"</span>";
