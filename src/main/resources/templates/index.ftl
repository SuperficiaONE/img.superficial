...
<script>
    ...
    layui.use(['form','jquery','table'], function(){
       ...
       var options= {
            ...
            ,{field: 'url', title: '链接', width:80, sort: false}
            ,{field: 'needLogin', title: '需要登录', width:80}
            ,{field: 'isBack', title: '后台接口', width: 177}
            ,{field: 'order', title: '排序', width: 80, sort: false}
            ,{field: 'createAt', title: '创建时间', width: 80, sort: false}
            ,{field: 'updateAt', title: '更新时间', width: 80}
