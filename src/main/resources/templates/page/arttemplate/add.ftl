...
<form class="layui-form" onsubmit="return false;">
    <div style="margin-left: auto;margin-right: auto;margin-top: 30px; width: 45%; border-radius: 20px;background-color: rgba(100,100,100,0.2);padding-bottom: 20px">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block" >
                <textarea class="layui-textarea" id="beforeScript" style="height: 100px;width: 400px" name="beforeScript"></textarea>
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">模板元素</label>
            <div class="layui-input-block" >
                <textarea id="templateElements" style="height: 100px;width: 400px" name="templateElements"></textarea>
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">模板脚本</label>
            <div class="layui-input-block" >
                <textarea  style="height: 100px;width: 400px" id="templateScript" name="templateScript"></textarea>
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">after脚本</label>
            <div class="layui-input-block" >
                <textarea id="afterScript" style="height: 100px;width: 400px" name="afterScript"></textarea>
            </div>
        </div>
        <div class="layui-form-item " >
            <label class="layui-form-label">数据结构</label>
            <div class="layui-input-block" >
                <textarea id="templateData" style="height: 100px;width: 400px" name="templateData"></textarea>
            </div>
        </div>
